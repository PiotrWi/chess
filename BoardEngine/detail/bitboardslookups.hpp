...
uint64_t evaluateLineAttacks(uint64_t blockers, unsigned int piecePosition);
uint64_t evaluateDiagonalAttacks(uint64_t blockers, unsigned int piecePosition);
