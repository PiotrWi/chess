...
{
    model = new cppflow::model("/home/pioter/proj/chess/ml-poc/STchess1000500r100r1rDO.tf");
...
int evaluatePosition(BoardEngine& be, unsigned int)
{
    ...
    auto out = (*model)({{"serving_default_dense_7_input:0", tensor}}, {"StatefulPartitionedCall:0"});
