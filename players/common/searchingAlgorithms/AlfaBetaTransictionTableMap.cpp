#include "AlfaBetaTransictionTableMap.hpp"
...
int evaluateMin(BoardEngine& be,
                CachedMoveGeneratorMap& moveGenerator,
                unsigned char depth,
...
Move evaluate(BoardEngine be, CachedMoveGeneratorMap& moveGenerator, unsigned char depth)
{
    auto validMoves = moveGenerator.generate(be);
